...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        CfnHealthCheck authDbHealthCheck =
                createDbHealthCheck(authServiceDb, "auth-db-health-check");

        CfnHealthCheck patientDbHealthCheck = createDbHealthCheck(patientServiceDb, "patient-db-health-check");
        ...
        FargateService authService = createFargateService("AuthService",
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "5O9fjHiT2+NCLJt6raSx6cilatkj+0BSnIuj417VKn8=")
        );

        authService.getNode().addDependency(authDbHealthCheck);
        authService.getNode().addDependency(authService);
